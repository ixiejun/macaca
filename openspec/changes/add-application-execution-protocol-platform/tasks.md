...
- [ ] 12.7 Add detailed English comments to new Rust code explaining protocol ownership, provider strategy, adapter boundaries, trace/audit behavior, sanitization, failure modes, and non-goals.
