# unified-execution-path Specification

## Purpose
Canonical service invocation and agent execution ownership for Macaca Agent OS. Established by refactor-unified-call-path-microkernel (2026-06-07).
