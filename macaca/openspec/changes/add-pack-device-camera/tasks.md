...
- [x] 4.6 Add lifecycle, health, snapshot, shutdown, timeout, cancellation, interruption handling, resource cleanup, media reference expiry, and bounded output behavior.
