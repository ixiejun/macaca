...
use super::support::{decode, runtime_policy, service_definition_payloads, service_lifecycle, snapshot_from_statuses, status_result, to_value};
...
Ok(McpSystemServiceProvider::service_result(super::support::to_value(snapshot)?, typed.trace))
    }
