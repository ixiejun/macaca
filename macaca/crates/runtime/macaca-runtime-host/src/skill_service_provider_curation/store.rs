//! Governance store Strategy implementation for skill curation commands.
//!
//! The Command handlers in `mod.rs` decode typed protocol DTOs and delegate
//! lifecycle work to `SkillProviderGovernanceState` methods defined here.
//! Memento capture/restore follows the Memento pattern for rollback audit.
