//! Contract tests for [`PlanNotebook`] and [`Plan`] state machine.

use crate::state::StateModule;

use super::super::aggregate::Plan;
use super::super::error::PlanError;
use super::super::notebook::PlanNotebook;
use super::super::types::{PlanState, SubTaskState};
