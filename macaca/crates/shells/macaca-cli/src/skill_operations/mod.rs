...
//! commands optionally reach a live runtime through the public Web HTTP facade,
//! and print bounded JSON summaries.  They
...
//! - **Null Object** — structured unavailable output when no live app id is
//!   supplied, preserving diagnostic semantics without faking success.
//! - **Strategy** — [`types::SkillCliLifecycleAction`] maps CLI verbs to public
...
pub use types::{SkillCliEvidenceRefs, SkillCliLifecycleAction, SkillCliRuntimeTarget};
