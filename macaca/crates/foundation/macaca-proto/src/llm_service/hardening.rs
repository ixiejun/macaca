...
//!
//! These provider-neutral DTOs cover catalog reads, route diagnostics, budget
//! visibility, degradation explanations, and continuation protocol validation.
...
use crate::{LlmMessage, TraceContext};

use super::{LlmPolicyHints, LlmRouteSummary, LlmServiceScope};

/// Command names added by the LLM hardening contract.
...
/// Route resolution command that supersedes model-selection dry runs.
#[derive(Debug, Clone, Serialize, Deserialize)]
