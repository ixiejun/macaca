...
- 8. 仅在代码和规范对齐后归档。
# OpenSpec 规则
- `macaca/openspec/specs/` 是基线事实来源。
- `macaca/openspec/changes/` 存储提议的增量变更。
- 使用 `proposal.md` 说明原因。
...
Always open `@/macaca/openspec/AGENTS.md` when the request:
- Mentions planning or proposals (words like proposal, spec, change, plan)
- Introduces new capabilities, breaking changes, architecture shifts, or big performance/security work
- Sounds ambiguous and you need the authoritative spec before coding

Use `@/macaca/openspec/AGENTS.md` to learn:
...
This project is indexed by GitNexus as **agent** (48039 symbols, 88656 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
