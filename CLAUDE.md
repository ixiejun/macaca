...
This project is indexed by GitNexus as **agent** (14466 symbols, 30685 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
