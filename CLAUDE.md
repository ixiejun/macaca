...
This project is indexed by GitNexus as **agent** (11205 symbols, 22612 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
