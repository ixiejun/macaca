...
This project is indexed by GitNexus as **agent** (32649 symbols, 60950 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
