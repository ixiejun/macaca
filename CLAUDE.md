...
This project is indexed by GitNexus as **agent** (4408 symbols, 10614 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
