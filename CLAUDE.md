...
This project is indexed by GitNexus as **agent** (5290 symbols, 12544 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
