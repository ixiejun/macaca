...
This project is indexed by GitNexus as **agent** (4420 symbols, 10639 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
