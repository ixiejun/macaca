...
This project is indexed by GitNexus as **agent** (4410 symbols, 10617 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
