...
This project is indexed by GitNexus as **agent** (37733 symbols, 70973 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
