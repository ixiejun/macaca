...
This project is indexed by GitNexus as **agent** (11602 symbols, 23252 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
