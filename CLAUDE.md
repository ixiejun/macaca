...
This project is indexed by GitNexus as **agent** (72192 symbols, 174516 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
