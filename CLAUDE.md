...
This project is indexed by GitNexus as **agent** (4624 symbols, 11072 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
