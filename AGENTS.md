...
This project is indexed by GitNexus as **agent** (10138 symbols, 21010 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
