...
This project is indexed by GitNexus as **agent** (31095 symbols, 58052 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
