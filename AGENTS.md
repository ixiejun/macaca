...
This project is indexed by GitNexus as **agent** (33830 symbols, 63076 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
