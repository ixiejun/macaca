...
This project is indexed by GitNexus as **agent** (34854 symbols, 65078 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
