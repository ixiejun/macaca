...
This project is indexed by GitNexus as **agent** (139045 symbols, 371560 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
