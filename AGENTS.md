...
This project is indexed by GitNexus as **agent** (12013 symbols, 23767 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
