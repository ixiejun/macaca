...
This project is indexed by GitNexus as **agent** (12661 symbols, 24747 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
