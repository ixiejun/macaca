...
This project is indexed by GitNexus as **agent** (31090 symbols, 58036 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
